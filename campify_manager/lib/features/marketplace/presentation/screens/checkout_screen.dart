          ...
          children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('\$${(cartTotal * 0.05).toStringAsFixed(2)}'),
                      ],
                    ),
                    const Divider(),
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '\$${(cartTotal * 1.05).toStringAsFixed(2)}',
                          style: theme.textTheme.titleMedium?.copyWith(
                            fontWeight: FontWeight.bold,
            ...
            FilledButton(
              ...
              child: _isProcessing
                  ...
                  : Text('Pay \$${(cartTotal * 1.05).toStringAsFixed(2)}'),
            ),
            const SizedBox(height: 16),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildDetailRow(
                        'Amount',
                        '\$${_completedOrder!.totalAmount.toStringAsFixed(2)}',
                      ),
                      const SizedBox(height: 8),
                      _buildDetailRow(
                        'Status',
